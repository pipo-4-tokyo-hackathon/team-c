...
use App\Mail\SendRequiredReminder;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Http;
use Illuminate\Support\Facades\Mail;

class SendRequiredReminderCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:send-required';
     ...
     * @var string
     */
    protected $description = 'Send required reminder to fill document';
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            Mail::send(new SendRequiredReminder($user['Email']));
        }
    }
}
